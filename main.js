...
const songListsCharts = Array.from($$(".playlist__list-charts"));
const songChartsContainer = $(".playlist__list-charts");
...
const app = {
                                    ...
                                    <div class="row__item-info new-playlist--info">
                                        ...
                                        <h3 class="row__info-creator">
                                            ${newPlaylist.singer.map((singer, index) => {
                                                return app.html`
                                                    <a href="#" class="is-ghost">${singer}</a>${
                                                    index < newPlaylist.singer.length - 1 && ","
                                                }
                                                `;
                                            })}
                    ...
                    <div class="container__header special-playlist--header">
                        <div class="row__item-info media">
                            <div class="media__left">
                                <div class="row__item-display br-5">
                                    <div class="row__item-img img--square" style="background: url('${
                                        app.specialPlaylists[playlistListIndex].header.image
                                    }') no-repeat center center / cover"></div>
                                </div>
                                                ...
                                                <p class="info__artist">
                                                    ${playlist.artists.map((artist, artistIndex) => {
                                                        return app.html`
                                                            ...
                                                            artistIndex < playlist.artists.length - 1 && ", "
                                                        }
                                                        `;
                                                    })}
                                                </p>
    ...
    renderTabCharts() {
        songChartsContainer.innerHTML = app.html`
            
            ${this.listSongCharts.map((song, songIndex) => {
                return app.html`
                    <div class="playlist__list-song media ${
                        songIndex > 9 && "song--not-expand"
    ...
    handleEvents: function () {
        ...
        const popUpCdThumbAnimate = popUpCdThumb.animate([{ transform: "rotate(360deg)" }], {
    ...
    titleAnimate(title) {
        ...
        const titleAnimate = title.animate(
            [{ transform: "translate(0px)" }, { transform: `translateX(-${this.slideTitleWidth}px)` }],
            {
